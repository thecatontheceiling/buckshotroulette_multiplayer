...
func _on_lobby_joined(this_lobby_id: int, _permissions: int, _locked: bool, response: int) -> void:
	...
	# Else it failed for some reason
		...
		match response:
			Steam.CHAT_ROOM_ENTER_RESPONSE_DOESNT_EXIST: p_fail_reason = "This lobby no longer exists." #delete this or move to separate match
			...
			_: lobby_ui.ShowPopupWindow("MP_UI LOBBY FAIL GENERIC")
